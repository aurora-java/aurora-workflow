...
public class ProcessLogProc implements ISqlCallEnabled {
	public synchronized void log(Long instance_id, Long user_id,
			String event_type, String log_content) throws Exception {
